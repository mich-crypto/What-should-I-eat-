...
import { suggestRecipeWithAI } from "./ai.js";
...
function mealRowHtml(day, dayIndex, meal, recipe) {
  ...
  return `
    <div class="meal-row" data-day="${dayIndex}" data-meal="${meal}">
      ${img}
      <div class="meal-info">
...
function renderSettings() {
  ...
  view.innerHTML = `
    ...
    <h2 class="section-title">AI recipe ideas</h2>
    <div class="card" style="padding:0 14px;">
      <div class="toggle-row">
        <div>
          <div class="t-label">Use Google AI (Gemini)</div>
          <div class="t-desc">Adds a "spark" button on Discover to invent a fresh recipe idea.</div>
        </div>
    ...
    <p class="hint">Stored only on this device (localStorage) and sent directly to Google when you ask for an idea. Get a free key at aistudio.google.com.</p>
